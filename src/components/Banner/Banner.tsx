...
export const Banner = () => {
  return (
    <>
      <section className="flex md:flex-row flex-col-reverse gap-32 justify-center items-center w-5/6 m-auto py-24">
        <div className="text-primary font-montserrat">
          <h3 className="md:text-6xl text-4xl max-w-96 m-auto">Somos FIRE, uma igreja VIVA.</h3>
          <p className="my-4 text-primary max-w-96 opacity-90 m-auto">Faça parte dessa família.</p>
        </div>
