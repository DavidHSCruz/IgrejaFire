    ...
    <main className="bg-quaternary text-primary flex justify-center mt-28">
      <section className="grid grid-cols-2 grid-rows-4 w-3/4 py-20 gap-x-20 gap-y-5">
        <div className="text-lg leading-loose row-span-4">
          ...
          <p className="pb-4 indent-7 opacity-90"> Nosso ministério acredita na verdade contida em <i className="text-primary">Hebreus 12:29</i>,
          ...
          <p className="pb-2 indent-7 opacity-90"> No dia 4 de fevereiro de 2017, respondendo ao chamado de Deus, nossa igreja teve início,
              destinada por Deus a tornar-se uma igreja relevante, saudável e crescente.</p>

          <p className="pb-2 indent-7 opacity-90"> Depois de trabalhar com jovens por mais de 7 anos, os Pastores Israel e Daiane Nascimento começaram uma pequena
          ...
          <p className="pb-2 indent-7 opacity-90"> Hoje após alguns anos somos uma igreja em constante crescimento tendo como cobertura espiritual a Comunidade Semear
          ...
          <p className="pb-2 indent-7 opacity-90"> <i className="text-primary">Provérbios 29:18</i> nos diz que: Não havendo visão o povo perece. Esta tem sido uma das palavras que
              tem norteado nossa igreja, buscamos ser integralmente obedientes à visão que nos foi confiada,
              abraçando-a de coração e nos empenhando em seu cumprimento. <i className="text-primary">(Atos 26:19)</i></p>

          <p className="indent-7 opacity-90"> Nosso nome reflete nossa visão de avivamento, do avivamento que Deus irá derramar sobre todas as nações,
