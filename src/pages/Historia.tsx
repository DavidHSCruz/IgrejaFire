...
export const Historia = () => {
  return (
    <main className="bg-zinc-950 text-zinc-300 font-montserrat flex justify-center">
      <section className="grid grid-cols-2 grid-rows-4 w-3/4 py-20 gap-x-20 gap-y-5">
        <div className="text-lg leading-loose row-span-4">
          <h1 className="text-4xl text-red-500 font-bold pb-4">POR QUE FIRE?</h1>

          <p className="pb-4 indent-7"> Nosso ministério acredita na verdade contida em <i className="text-zinc-50">Hebreus 12:29</i>,
          ...
          <h2 className="text-3xl text-red-500   font-bold pb-4">HISTÓRIA</h2>
          ...
          <p className="pb-2 indent-7"> <i className="text-zinc-50">Provérbios 29:18</i> nos diz que: Não havendo visão o povo perece. Esta tem sido uma das palavras que
              tem norteado nossa igreja, buscamos ser integralmente obedientes à visão que nos foi confiada,
              abraçando-a de coração e nos empenhando em seu cumprimento. <i className="text-zinc-50">(Atos 26:19)</i></p>
          ...
          <Card className="bg-[url(/img/imagem7.jpg)] bg-cover mx-24 mr-40"></Card>
      </section>
    </main>
  )
}
